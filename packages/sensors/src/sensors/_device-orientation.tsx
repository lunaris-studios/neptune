...
> {
	public static displayName = `DeviceOrientationSensor`;
...
export const withDeviceOrientationSensor = Universal.createEnhancer(DeviceOrientationSensor, "sensors", "deviceOrientation");
