...
export declare class Icon extends Components.AbstractPureComponent<IIconProps & React.DOMAttributes<HTMLElement>> {
    static displayName: string;
    static readonly SIZE_STANDARD = Components.IconSize.SIZE_STANDARD;
    static readonly SIZE_LARGE = Components.IconSize.SIZE_LARGE;
    static readonly defaultProps: IIconProps;
