...
import { defaultState } from "~/redux/reducers/_device";
import { IPopoverArrowProps } from "./popover-arrow";
...
const defaultProps = Object.freeze<IPopoverProps>({
...
const defaultState = Object.freeze<IPopoverState>({
	hasDarkParent: false,
...
export class Popover extends AbstractPureComponent2<IPopoverProps, IPopoverState> {
	...
	static readonly defaultProps: IPopoverProps = defaultProps;
	public readonly state: IPopoverState = defaultState;
