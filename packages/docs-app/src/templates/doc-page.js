...
import * as RC from '@nucleus/core';
...
function DocPageTemplate({ data, location, ...props }) {
  ...
  return (
    <Layout pathname={location.pathname}>
      <Helmet>
        <title>Nucleus — {data.mdx.frontmatter.title}</title>
        <meta property="og:title" content={`Nucleus — ${data.mdx.frontmatter.title}`} />
        <meta property="og:description" content={data.mdx.frontmatter.description} />
        <meta name="twitter:title" content={`Nucleus — ${data.mdx.frontmatter.title}`} />
