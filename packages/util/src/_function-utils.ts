...
export function safeInvokeOrValue<A, R>(
	funcOrValue: ((arg1: A) => R) | R | undefined,
	arg1: A,
): R;
export function safeInvokeOrValue<A, B, R>(
	funcOrValue: ((arg1: A, arg2: B) => R) | R | undefined,
	arg1: A,
	arg2: B,
): R;
...
export function safeInvokeOrValue(
	funcOrValue: Function | any | undefined,
	...args: any[]
) {
