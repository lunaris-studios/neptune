...
const boxShadowElevation = BIN.bind.variants("scheme", "elevation", {
	[Constants.Elevation.ZERO]: {
		[Constants.Scheme.LIGHT]: css`
			box-shadow: 0 0 0 1px ${Constants.Color.BLACK_5}, 0 0 0 ${Constants.Color.TRANSPARENT},
				0 0 0 ${Constants.Color.TRANSPARENT};
		`,
		[Constants.Scheme.DARK]: css`
			box-shadow: 0 0 0 1px ${Constants.Color.BLACK_4}, 0 0 0 ${Constants.Color.TRANSPARENT},
				0 0 0 ${Constants.Color.TRANSPARENT};
		`,
	},
	[Constants.Elevation.ONE]: {
		[Constants.Scheme.LIGHT]: css`
			box-shadow: 0 0 0 1px ${Polished.rgba(Constants.Color.BLACK_1, BORDER_SHADOW_OPACITY_LIGHT)},
				0 0 0 ${Constants.Color.TRANSPARENT},
				0 1px 1px ${Polished.rgba(Constants.Color.BLACK_1, DROP_SHADOW_OPACITY_LIGHT)};
		`,
		[Constants.Scheme.DARK]: css`
			box-shadow: 0 0 0 1px ${Polished.rgba(Constants.Color.BLACK_1, BORDER_SHADOW_OPACITY_DARK)},
				0 0 0 ${Constants.Color.TRANSPARENT},
	...
	[Constants.Elevation.FOUR]: {
		[Constants.Scheme.LIGHT]: css`
			box-shadow: 0 0 0 1px ${Polished.rgba(Constants.Color.BLACK_1, BORDER_SHADOW_OPACITY_LIGHT)},
				...
				0 18px 46px 6px ${Polished.rgba(Constants.Color.BLACK_1, DROP_SHADOW_OPACITY_LIGHT)};
		`,
		[Constants.Scheme.DARK]: css`
			box-shadow: 0 0 0 1px ${Polished.rgba(Constants.Color.BLACK_1, BORDER_SHADOW_OPACITY_DARK)},
				0 4px 8px ${Polished.rgba(Constants.Color.BLACK_1, DROP_SHADOW_OPACITY_DARK)},
				0 18px 46px 6px ${Polished.rgba(Constants.Color.BLACK_1, DROP_SHADOW_OPACITY_DARK)};
		`,
	},
});
