...
import * as RC from '@neptune/core';
...
function DocPageTemplate({ data, location, ...props }) {
  ...
  return (
    <Layout pathname={location.pathname}>
      <Helmet>
        <title>Neptune — {data.mdx.frontmatter.title}</title>
        <meta property="og:title" content={`Neptune — ${data.mdx.frontmatter.title}`} />
        <meta property="og:description" content={data.mdx.frontmatter.description} />
        <meta name="twitter:title" content={`Neptune — ${data.mdx.frontmatter.title}`} />
