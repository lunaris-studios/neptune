...
const ColorCard = ({ color, name, props }) => (
  <Box {...props}>
    <Box>
      ...
      <Box mt={1}>
        <NucleusHeading as="h4" size={0} weight="medium" mt={2} mb={1}>
...
const Heading = props => <NucleusHeading as="h2" weight="medium" size={2} mt={8} mb={4} {...props} />;

const Subheading = props => (
  <NucleusHeading as="h3" weight="medium" size={1} mt={6} mb={4} {...props} />
);
